...
import { Moon01Icon as Moon, Sun01Icon as Sun } from "hugeicons-react";
...
export const ThemeToggleButton = ({
  ...
  return (
    <button
      onClick={toggleTheme}
      className={cn(
        "w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center p-2 text-foreground/80 hover:bg-foreground/10 hover:text-foreground transition-colors",
        className,
      )}
